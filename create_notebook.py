    ...
    "cells": [
        {
            ...
            "source": [
                ...
                "\n",
                "This notebook provides an interactive interface to train SolarKnowledge models for solar flare prediction using the enhanced PyTorch implementation with batch normalization, AdamW optimizer, and cosine annealing learning rate scheduling."
            ]
        },
        {
            "cell_type": "markdown",
        ...
        },
        {
            ...
            "source": [
                ...
                "    options=[('5e-5', 5e-5), ('1e-4', 1e-4), ('5e-4', 5e-4), ('1e-5', 1e-5)],\n",
                "    value=5e-5,\n",
                ...
                "    options=['cosine_with_restarts', 'cosine_annealing', 'reduce_on_plateau'],\n",
                "    value='cosine_with_restarts',\n",
                "    description='LR Scheduler:',\n",
                "    disabled=False\n",
                ")\n",
                "\n",
                "embed_dim_dropdown = widgets.Dropdown(\n",
                "    options=[('128', 128), ('256', 256), ('512', 512)],\n",
                "    value=256,\n",
                "    description='Embed Dim:',\n",
                "    disabled=False\n",
                ")\n",
                "\n",
                "transformer_blocks_dropdown = widgets.Dropdown(\n",
                "    options=[('6', 6), ('8', 8), ('12', 12)],\n",
                "    value=8,\n",
                "    description='Transformer Blocks:',\n",
                "    disabled=False\n",
                ")\n",
                "\n",
                ...
                ")\n",
                "\n",
                "batch_norm_checkbox = widgets.Checkbox(\n",
                "    value=True,\n",
                "    description='Use batch normalization',\n",
                "    disabled=False\n",
                ")\n",
                "\n",
                "focal_loss_checkbox = widgets.Checkbox(\n",
                "    value=True,\n",
                "    description='Use focal loss',\n",
                "    disabled=False\n",
                ")\n",
                "\n",
                "# Group advanced options in an accordion widget\n",
                "advanced_options = widgets.Accordion(children=[\n",
                "    widgets.VBox([\n",
                "        widgets.HBox([epochs_slider, patience_slider]),\n",
                "        widgets.HBox([learning_rate_dropdown, scheduler_dropdown]),\n",
                "        widgets.HBox([embed_dim_dropdown, transformer_blocks_dropdown, batch_size_dropdown]),\n",
                "        widgets.HBox([batch_norm_checkbox, focal_loss_checkbox])\n",
                "    ])\n",
                "])\n",
                "advanced_options.set_title(0, 'Advanced Model Options')\n",
                "\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "        embed_dim = embed_dim_dropdown.value\n",
                "        transformer_blocks = transformer_blocks_dropdown.value\n",
                "        batch_size = batch_size_dropdown.value\n",
                "        use_batch_norm = batch_norm_checkbox.value\n",
                "        use_focal_loss = focal_loss_checkbox.value\n",
                "        \n",
                "        # Validate selections\n",
                ...
                "            return\n",
                "        \n",
                "        # Construct scheduler parameters based on selected scheduler\n",
                "        scheduler_params = {}\n",
