...
from solar_knowledge.data import create_train_test_split, load_tiny_dataset


def parse_args():
    parser = argparse.ArgumentParser(
        description="Run smoke training on a small dataset"
    )
    parser.add_argument(
        "--data-dir",
        type=str,
...
def main():
    ...
    try:
        ...
        print(
            f"Successfully loaded dataset: {len(x_train)} training samples, {len(x_test)} test samples"
        )
