    ...
    "cells": [
        {
            ...
            "source": [
                ...
                "\n",
                "This notebook provides an interface to train SolarKnowledge models for solar flare prediction using the PyTorch implementation that exactly matches the TensorFlow version's behavior for direct comparison."
            ]
        },
        {
            "cell_type": "markdown",
        ...
        },
        {
            ...
            "source": [
                ...
                "scheduler_type = 'reduce_on_plateau'  # Match TensorFlow's default\n",
                ...
                "    scheduler_params = {\n",
                "        \"factor\": 0.5,     # Reduction factor (match TensorFlow)\n",
                "        \"patience\": 3,     # Patience (match TensorFlow)\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "                            \"l2\": 1e-4\n",
                "                        },\n",
                "                        \"optimizer\": \"Adam\",     # Match TensorFlow\n",
