    ...
    for i, time_window in enumerate(time_windows):
        ...
        for flare_class in flare_classes:
            ...
            if time_window in original_results and flare_class in original_results[time_window]:
                orig_value = original_results[time_window][flare_class].get(metric, 'N/A')
                if orig_value == 'N/A':
                    orig_value = 0
            else:
                orig_value = 0
            ...
            if time_window in multimodal_results and flare_class in multimodal_results[time_window]:
                multi_value = multimodal_results[time_window][flare_class].get(metric, 'N/A')
                if multi_value == 'N/A':
                    multi_value = 0
            else:
                multi_value = 0
        ...
        axes[i].bar(index + bar_width, multimodal_values, bar_width, label='Multimodal')
...
if __name__ == '__main__':
    ...
    for metric in ['TSS', 'accuracy', 'precision', 'recall', 'balanced_accuracy']:
