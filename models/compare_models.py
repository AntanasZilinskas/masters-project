...
def plot_comparison(original_results, multimodal_results, metric="TSS"):
    ...
    for i, time_window in enumerate(time_windows):
        ...
        for flare_class in flare_classes:
            ...
            if (
                time_window in original_results
                and flare_class in original_results[time_window]
            ):
            ...
            if (
                time_window in multimodal_results
                and flare_class in multimodal_results[time_window]
            ):
        ...
        axes[i].bar(
            index + bar_width, multimodal_values, bar_width, label="Multimodal"
        )
