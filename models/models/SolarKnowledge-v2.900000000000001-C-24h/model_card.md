# SolarKnowledge Model v2.900000000000001

## Overview
- **Created**: 2025-05-09 03:57
- **Type**: Solar flare prediction model
- **Target**: C-class flares
- **Time Window**: 24 hours

## Description
Iteration on v2.8000000000000007 model for C-class flares with 24h window

## Performance Metrics
- **final_training_accuracy**: 0.9928
- **final_training_loss**: 0.0052
- **epochs_trained**: 100
- **final_training_tss**: 0.9464
...
model.load_model(
    input_shape=(10, 9),
    flare_class="C",
    w_dir="SolarKnowledge-v2.900000000000001-C-24h"
)
