# SolarKnowledge Model v2.5000000000000004

## Overview
- **Created**: 2025-05-09 02:53
- **Type**: Solar flare prediction model
- **Target**: C-class flares
- **Time Window**: 24 hours

## Description
Iteration on v2.4000000000000004 model for C-class flares with 24h window
...
model.load_model(
    input_shape=(10, 9),
    flare_class="C",
    w_dir="SolarKnowledge-v2.5000000000000004-C-24h"
)
