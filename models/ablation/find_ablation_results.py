...
def identify_ablation_models(recent_models):
    ...
    for model_info in recent_models:
        ...
        if metadata:
            ...
            if (metadata['flare_class'] == 'M5' and 
                metadata['time_window'] == '72' and
                'ablation' in metadata.get('description', '').lower()):
                
                model_info['metadata'] = metadata
                model_info['experiment_type'] = 'ablation'
                ablation_models.append(model_info)
            elif (metadata['flare_class'] == 'M5' and 
                  metadata['time_window'] == '72'):
