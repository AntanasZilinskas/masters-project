...
"""
    ...
    def _generate_prospective_case_study(self):
        ...
        start_time = datetime(2012, 7, 21, 0, 0)  # 48 h before flare
    ...
    def _generate_case_study_confusion_matrix(self, alert_time, flare_time):
        ...
        confusion_data = {
            ...
            'Flare': [1, 0, 1],
            'Quiet (24 h)': [2, 22, 24],  # 2 false alarms in 24 h window
            'Total': [3, 22, 25]
        }
    ...
    def _generate_cost_benefit_analysis(self):
        ...
        savings_values = [
            (110 - 41) * 12000 / 1 e6,  # False alarm savings (£12 k/day)
            (12 - 4) * 5,  # Missed event savings (£5 M each)
