...
def verify_dataset_integrity(data_dir: str, manifest_file: str = "dataset_manifest.json"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--create-manifest", action="store_true", help="Create new manifest")
