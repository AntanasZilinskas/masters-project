...
class ImageEncoder(layers.Layer):
    def __init__(self, embed_dim=128):
        ...
        self.conv1 = layers.Conv2D(32, kernel_size=3, strides=2, padding='same', activation='relu')
        self.bn1 = layers.BatchNormalization()
        self.conv2 = layers.Conv2D(64, kernel_size=3, strides=2, padding='same', activation='relu')
        self.bn2 = layers.BatchNormalization()
        self.conv3 = layers.Conv2D(128, kernel_size=3, strides=2, padding='same', activation='relu')
        self.bn3 = layers.BatchNormalization()
        self.conv4 = layers.Conv2D(256, kernel_size=3, strides=2, padding='same', activation='relu')
...
class MultimodalSolarKnowledge:
    ...
    def build_base_model(self, time_series_shape, image_shape=(256, 256, 1)):
        ...
        """
        # Time series input
        time_series_inputs = layers.Input(shape=time_series_shape, name="time_series_input")
    ...
    def train(self, X_time_series, X_images, y, validation_split=0.1, epochs=100, batch_size=32, verbose=1):
        """
    ...
    def load_model(self, time_series_shape, image_shape, flare_class, w_dir=None, verbose=True):
