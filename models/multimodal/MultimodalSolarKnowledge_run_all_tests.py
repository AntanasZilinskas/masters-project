...
def test_model(time_window, flare_class):
    log("Multimodal testing initiated for time window: " + str(time_window) + " and flare class: " + flare_class, verbose=True)
    
    # Load the testing data
    X_time_series, X_images, y_test = get_multimodal_testing_data(time_window, flare_class)
    ...
    print("==============================================")
    print(f"Multimodal accuracy for flare class {flare_class} with time window {time_window}: {acc:.4f}")
