...
def get_paper_ece_numbers():
    ...
    print(f"   Literature: Transformers with >99% accuracy typically show ECE 0.15-0.25")
    ...
    print(f'   Conservative estimate: "ECE drops from {sk_conservative:.3f} to {everest_ece:.3f}"')
    ...
    print(f'📝 "ECE drops from {solarknowledge_ece:.3f} to {everest_ece:.3f}, achieving a {improvement_pct:.1f}% improvement in calibration via evidential deep learning."')
