...
class MissingAnalysisGenerator:
    ...
    def _generate_attention_heatmaps(self):
        ...
        samples = [
            ...
            (
                "False Positive",
                "Attention on noise patterns, misinterpreted as precursors",
            ),
...
"""
        ...
        plt.savefig(
            self.output_dir / "figures" / "attention_heatmaps.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
    ...
    def _generate_prospective_case_study(self):
        ...
        uncertainties = [
            0.05 + 0.1 * p * (1 - p) for p in probabilities
        ]  # Higher uncertainty at mid-range
        ...
        plt.savefig(
            self.output_dir / "figures" / "prospective_case_study.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
    ...
    def _generate_case_study_confusion_matrix(self, alert_time, flare_time):
        ...
        df.to_csv(
            self.output_dir / "data" / "case_study_confusion_matrix.csv", index=False
        )
    ...
    def _generate_ui_demonstration(self):
        ...
        plt.savefig(
            self.output_dir / "figures" / "ui_dashboard.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
    ...
    def _generate_environmental_analysis(self):
        ...
        plt.savefig(
            self.output_dir / "figures" / "environmental_analysis.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
    ...
    def _generate_cost_benefit_analysis(self):
        ...
        plt.savefig(
            self.output_dir / "figures" / "cost_benefit_analysis.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
    ...
    def _generate_architecture_evolution(self):
        ...
        plt.savefig(
            self.output_dir / "figures" / "architecture_evolution.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
